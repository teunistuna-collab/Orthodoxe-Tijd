...
export default function Vandaag() {
  const { mode, setMode, vandaag, vandaagYmd, htc, openDag, openLezing, openDagLezingen, openDagHeiligen, openDagPascha } = useApp();
