  ...
  return (
    <section id="vandaag" className="vandaag-design-page">
      <div className="vandaag-frame">
        ...
        <div className="vandaag-cover"><img src="/images/heroes/hero-vandaag.png" alt="Orthodoxe gebedssfeer bij kaarslicht" /><div className="vandaag-cover-shade"/><div className="vandaag-cover-copy"><span>In Gods tegenwoordigheid</span><strong>{hoofdletter(dag.weekdagNaam)} · {formatDatum(dag.civil)}</strong></div></div>
