...
export default function Feesten() {
  ...
  return <>
    <section id="feesten" className="bg-bark page-hero-crop"><img loading="lazy" decoding="async" src="/images/heroes/hero-feesten.webp" width={2103} height={748} alt="Feesten — Orthodoxe Tijd"/></section>
